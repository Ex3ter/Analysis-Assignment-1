...
I'm not entirely sure if this is a viable usage of Linear Regression, but I'm going to try and see if game number or match duration correlate with my win rate.
...
#Make the list
duration <- c(26, 52.3, 56.7, 53.7, 54, 76, 77.3, 65.5, 76, 78, 79, 64, 65, 74.5, 60.5, 61.3, 69.5, 64, 65, 64.3, 60.5, 54, 61, 62.5, 52)
...
Maybe using just the average match duration will yield a relation?

```{r remove game_number}
summary(lm(Win. ~ Average_match_duration, data=dat))
```
